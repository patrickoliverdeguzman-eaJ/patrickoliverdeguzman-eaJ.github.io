/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=cms-worker/wrangler.jsonc cms-worker/worker-configuration.d.ts` (hash: a361defe21b17fcc683c43537ab717d4)
