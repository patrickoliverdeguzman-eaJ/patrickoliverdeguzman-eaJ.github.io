/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=cms-worker/wrangler.jsonc cms-worker/worker-configuration.d.ts` (hash: 3e25a05d7d9f5545796e2aaaaeafa6c7)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUBLIC_ORIGINS">> {}
}
